...
function Post() {
        ...
        const fetchUserLikes = async () => {
            try {
                ...
                if (userData) {
                    ...
                    const likedPostsSnapshot = await getDocs(query(likedPostsCollection, where('id', 'in', Object.keys(likedPostsData))));
        ...
        const fetchUserSaves = async () => {
            try {
                ...
                if (userData) {
                    ...
                    const savedPostsSnapshot = await getDocs(query(savedPostsCollection, where('id', 'in', Object.keys(savedPostsData))));
    ...
    return (
        <div>
        <div style={{ position: 'fixed',top:'7rem', left: '1rem' }}>
                <div className="max-w-sm mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
                    <img src={profile} alt="profilepic" className="w-full h-48 object-cover" style={{ borderRadius: '50%', width: '30vh', height: '30vh', margin: 'auto' }} />
                    <div className="p-6 text-center">
                        <h1 className="text-2xl font-bold">Name</h1>
                        <p className="text-gray-600 text-lg">CEO & Founder, Example</p>
                        <p className="mt-2 text-gray-500">University</p>
                        <button className="mt-4 w-full py-2 bg-black text-white text-lg font-semibold rounded hover:opacity-70" onClick={()=>{navigate('profile')}}>
                            View Full Profile
                        </button>
                    </div>
                </div>
        ...
        <div className="bg-gray-900 text-white font-roboto max-w-xl mx-auto p-4">
